...
{
    public function __construct(protected readonly VerificationCodeService $verificationService, protected readonly UserService $userService) {}

    public function __invoke(SendVerificationCodeRequest $sendVerificationCodeRequest)
    {
        $user = $this->userService->findByKey('email', $sendVerificationCodeRequest->email);
